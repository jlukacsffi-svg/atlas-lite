...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260805-warning-benchmarks', html)
        self.assertIn('/app.js?v=20260805-warning-benchmarks', html)
        ...
        self.assertIn("Paper evidence updates", script)
        self.assertIn("Forward review study starts with the next snapshot", script)
        self.assertIn("recent_transitions", script)
        self.assertIn(".owner-signal-digest-list", styles)
        self.assertIn('href="#about"', html)
        self.assertIn('aria-label="Open Atlas summary page"', html)
        ...
        self.assertIn("Independent score, thesis, trend, and news-risk exits remain active", script)
        ...
        self.assertIn("Open Stage 5 validation and learning detail", html)
        ...
        self.assertIn("Portfolio focus right now", html)
        ...
        self.assertIn("Formal proposals plus position warnings", script)
        ...
        self.assertIn('data-controls-target="control-strategy-panel"', script)
