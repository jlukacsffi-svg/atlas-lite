...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn("Strongest current-policy sector", script)
        self.assertIn("Current-policy sector to review", script)
        self.assertIn("sector_attribution", script)
    ...
    def test_dashboard_explains_sections_and_terms(self):
        ...
        self.assertIn("Collection health", script)
        self.assertIn("Entry study observation overdue", script)
