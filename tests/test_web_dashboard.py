...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260625-recommendation-clarity', html)
        self.assertIn('/app.js?v=20260625-recommendation-clarity', html)
        ...
        self.assertIn("Why now / why reduce", script)
