...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260704-research-auto-manage', html)
        self.assertIn('/app.js?v=20260704-research-auto-manage', html)
        ...
        self.assertIn("Paper learning ${recommendationCalibrationAdjustment(item) >= 0 ? \"+\" : \"\"}", script)
