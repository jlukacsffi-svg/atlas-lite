...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260726-research-workspace', html)
        self.assertIn('/app.js?v=20260726-research-workspace', html)
        ...
        self.assertIn("Atlas ranks active paper proposals beside already-open simulated holdings", html)
