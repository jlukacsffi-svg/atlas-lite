...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260807-simplified-workspace', html)
        self.assertIn('/app.js?v=20260807-simplified-workspace', html)
        ...
        self.assertIn("Priority escalation watch", script)
        self.assertIn("signalDigest.hidden = !prospectiveTracker.available || !latestPriorityEscalations.length", script)
