...
class WebDashboardTests(unittest.TestCase):
    ...
    def test_browser_labels_local_and_cloud_environments(self):
        ...
        self.assertIn('/styles.css?v=20260624-exit-trim', html)
        self.assertIn('/app.js?v=20260624-exit-trim', html)
        ...
        self.assertIn("recommended for simulated exit / trim", script)
        self.assertIn("Record simulated exit / trim", script)
        self.assertIn("exit-tag", styles)
        self.assertIn("exit-panel", styles)
        self.assertIn(".info-popover[open] summary:not(:hover):not(:focus-visible) + p", styles)
